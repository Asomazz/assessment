...
console.log("remove: ", removeProductById(products, 202));
...
const getProductsByPriceRange = (products, minPrice, maxPrice) => {
  // return products.filter((product) => {
...
console.log("range", getProductsByPriceRange(products, 19.99, 59.99));
